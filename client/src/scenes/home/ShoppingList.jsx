...
const ShoppingList = () => {
    ...
    const ridingGearItems = items.filter(
      (item) => item.attributes.category === "ridingGear"
    );
    const accessoriesItems = items.filter(
    ...
    return (
      <Box width="80%" margin="80px auto">
        ...
        >
          ...
          <Tab label="RIDING GEAR" value="ridingGear" />
